...
namespace _04_Loops
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //1-2-4-8-16.... Bir bakteri her saatin sonunda kendini ikiye bölerek çoğalmaktadır. Yeni oluşan bakteriler de aynı şekilde çoğalıyor. 24 saatin sonunda kaç bakteri?
